    ...
    return (
        <View style={{ backgroundColor: "#fff", height: '100%' }}>
            ...
            <View style={styles.container}>
                ...
                <Text style={styles.info}>We have sent an OTP on your registered email id {email}</Text>
                <CodeField
                    ref={ref}
                    value={value}
                ...
                <TouchableOpacity
                    ...
                    onPress={() => getOTP()}
                >
                    <Text style={{ textAlign: 'center', marginTop: 8, color: '#fff', fontWeight: "bold", fontSize: 18 }}>Next</Text>
                </TouchableOpacity>
            </View>
        </View >
    );
