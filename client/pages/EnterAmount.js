    ...
    return (
        <View>
            ...
            <View style={{ alignItems: 'center' }}>
                ...
                >
                    {payingTo.phoneNumbers[0].number}</Text>
            ...
            {showSheet ? (<BottomSheet
                ...
                body={
                    <View>
                        <Text style={{ marginLeft: 10, fontSize: 16 }}>Paying From {payer.name + ' --->'} {payingTo.name}</Text>
                        <Text style={{ fontSize: 22, marginLeft: 14, fontWeight: 'bold' }}>{'\u20B9'} {amount}</Text>
                        <TouchableOpacity
                            style={{
